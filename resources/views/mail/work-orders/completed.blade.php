<x-mail.layout title="Work Order Completed" :greeting="'Hi ' . $workOrder->assignedTo->name . ','">
    <p style="margin: 0 0 30px; color: #374151; font-size: 16px; line-height: 1.6;">
        The work order has been marked as completed by the creator. Please review for your records.
    </p>

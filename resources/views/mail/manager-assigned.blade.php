                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <p style="margin: 0 0 20px; color: #374151; font-size: 16px; line-height: 1.6;">
                                Hi <strong>{{ $manager->name ?? 'there' }}</strong>,
                            </p>

                            <p style="margin: 0 0 30px; color: #374151; font-size: 16px; line-height: 1.6;">
                                Great news! <strong>{{ $organization->name }}</strong> has assigned you as <strong>{{ $designation }}</strong> for the following facility:
                            </p>
                            ...
                            <p style="margin: 0 0 30px; color: #374151; font-size: 16px; line-height: 1.6;">
                                You can now access and manage this facility through your dashboard. Click the button below to get started:
                            </p>
                            ...
                            <table role="presentation" style="width: 100%;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ route('app.facilities.show', $facility) }}" 

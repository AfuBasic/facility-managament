                ...
                <div class="bg-white rounded-lg border border-slate-200 p-4 hover:border-teal-300 hover:shadow-md transition-all">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-2 pt-3 border-t border-slate-200">
                            <a href="{{ route('app.asset.detail', $asset) }}" 
                                class="flex-1 inline-flex items-center justify-center gap-1.5 rounded-lg bg-teal-600 text-white px-3 py-2 text-sm font-medium hover:bg-teal-700 transition-all">
                            ...
                            @can('edit assets')
                                <button 
                                    ...
                                    class="inline-flex items-center justify-center gap-1.5 rounded-lg bg-slate-50 px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100 transition-all">

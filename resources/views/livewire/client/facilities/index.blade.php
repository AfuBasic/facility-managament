            ...
            @foreach($facilities as $facility)
                <div class="group relative bg-white rounded-xl border border-slate-200 p-6 hover:shadow-lg hover:border-teal-300 transition-all duration-200">
                    ...
                    <div class="mt-6 flex items-center gap-2">
                        ...
                        @can('edit facilities')
                            <button wire:click="edit({{ $facility->id }})" class="inline-flex items-center justify-center rounded-lg bg-slate-100 p-2 text-slate-700 hover:bg-slate-200 transition-all">
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">

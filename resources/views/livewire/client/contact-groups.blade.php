<div class="p-2 space-y-2 md:p-6 md:space-y-6">
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Contact Groups</h1>
            <p class="text-sm text-slate-600 mt-1">Manage contact group categories</p>
        </div>
        @can('create contacts')
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <button 
                                    ...
                                    class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium {{ $group->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-slate-100 text-slate-800' }}"
                                >
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    @can('edit contacts')
                                        <button wire:click="edit({{ $group->id }})" class="text-teal-600 hover:text-teal-900">
                                            Edit
                                        </button>
                                    @endcan
                                    @can('delete contacts')

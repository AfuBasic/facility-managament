        ...
        <div class="p-8">
            ...
            <form wire:submit="login" class="space-y-6">
                ...
                <div class="group">
                    <div class="flex justify-between items-center mb-1 ml-1">
                        ...
                        <a href="{{ url('/forgot-password') }}" wire:navigate class="text-xs text-teal-400 hover:text-teal-300 transition-colors">Forgot password?</a>
                    </div>
            ...
            <div class="relative my-6">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-4 bg-transparent text-teal-200/60">or continue with</span>
                </div>
            </div>
